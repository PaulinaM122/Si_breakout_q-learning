...
from agents.complex_agent import ComplexAgent
...
plt.title("Complex Q-learning - liczba pozostałych klocków na koniec gry\nśrednia: " + str(average))
plt.xlabel("numer gry")
plt.ylabel("liczba pozostałych klocków")
plt.savefig("charts/complex_agent.png")
